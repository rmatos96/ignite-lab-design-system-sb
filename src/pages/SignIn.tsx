  ...
  return (
    <div className='w-screen h-screen bg-gray-900 flex flex-col items-center justify-center text-gray-100'>
      <header className='flex flex-col items-center'>
        ...
        <Text size='lg' clasName='text-gray-400 mt-1'>
      ...
      <form onSubmit={handleSignIn} className='flex flex-col items-stretch gap-4 w-full max-w-sm mt-10'>
        ...
        <label htmlFor='password' className='flex flex-col gap-3'>
          <Text clasName='font-semibold'>Senha</Text>
          <TextInput.Root>
            <TextInput.Icon>
              <Lock />
            </TextInput.Icon>
        ...
        <Button type='submit' className='mt-4'>Entrar na paltaforma</Button>
      </form>
